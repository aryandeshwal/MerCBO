...
def load_model_data(path, exp_dir=EXPERIMENTS_DIRECTORY):
...
def displaying_and_logging(logfile_dir, eval_inputs, eval_outputs, pred_mean_list, pred_std_list, pred_var_list,
                           time_list, elapse_list, hyper_samples, log_beta_samples, store_data=True):
	...
	if store_data:
		...
		torch.save({'inputs': eval_inputs, 'outputs': eval_outputs, 'hyper_samples': hyper_samples, 'log_beta_samples': log_beta_samples, 'per_itr_time_list': elapse_list}, pklfilename)
