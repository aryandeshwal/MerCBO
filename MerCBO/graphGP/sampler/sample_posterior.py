...
from MerCBO.graphGP.sampler.sample_hyper import slice_hyper
from MerCBO.graphGP.sampler.sample_edgeweight import slice_edgeweight
from MerCBO.graphGP.sampler.tool_partition import direct_product
PROGRESS_BAR_LEN = 50
